...
//        while (Mathf.Abs(tempAngle - prevtargetAngle) < Mathf.Abs(AppData.pROM()[1] - AppData.pROM()[0]) / 2.5f)
//        {
...
//        return (-2f + (angle - AppData.pROM()[0]) * (playSize) / (AppData.pROM()[1] - AppData.pROM()[0]));
