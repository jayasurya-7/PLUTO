...
public static class PlutoComm
{
    ...
    public static readonly int[] CALIBANGLE = new int[] { 0, 136, 136, 192, 93, 270, 270 }; // The first zero value is a dummy value.
    public static readonly float[] MECHOFFSETVALUE = new float[] {
        ...
        96,   // Forearm Prono/Sunpination
        0,    // Hand Opening/Closing 
        135,    // Functional mechanism 1
