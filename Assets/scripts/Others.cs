...
//     // Filter relevant rows by mechanism and game name
...
//     // Extract the first (most recent) row
//     var firstRow = filteredRows
//         .FirstOrDefault(row =>
//             DateTime.ParseExact(row.Field<string>("DateTime"), DataManager.DATEFORMAT, CultureInfo.InvariantCulture).Date == today);

//     if (firstRow != null)
//     {
//         lastTwoRates.Add(Convert.ToSingle(firstRow["SuccessRate"]));
//     }

//     // Now find the most recent previous day row (excluding today's row if already added)
//     var previousRow = filteredRows
//         .FirstOrDefault(row =>
//             DateTime.ParseExact(row.Field<string>("DateTime"), DataManager.DATEFORMAT, CultureInfo.InvariantCulture).Date < today);

//     if (previousRow != null)
//     {
//         lastTwoRates.Add(Convert.ToSingle(previousRow["SuccessRate"]));
//     }
